#==============================================================================
# Build All - Unified build script for Radia project
# Usage: .\build_all.ps1 [-BuildType Release|Debug] [-Clean] [-Test]
#==============================================================================
...
Write-Host "  Radia Project - Build All" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
& powershell -ExecutionPolicy Bypass -File .\Build.ps1 @radiaArgs
