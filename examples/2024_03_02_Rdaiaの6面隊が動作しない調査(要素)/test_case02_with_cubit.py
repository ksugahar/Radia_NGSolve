#!/usr/bin/env python
"""
Test case_02 with actual Cubit mesh generation
...
print("="*60)
print("Case 02: Multiple webcuts with Cubit + Radia")
print("="*60)
